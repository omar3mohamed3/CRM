...
import { closePropertyDetailsModal } from "../../../Store/settingsPropertyDetails/settingsPropertyDetailsSlice";

const AddPropertyDetails = () => {
  // Edit Service
  const dispatch = useDispatch();
  const { editedDetails, isModalOpen } = useSelector(
  ...
  const closeServiceModal = () => {
    dispatch(closePropertyDetailsModal());
  };
  return (
    <Modal
      isOpen={isModalOpen}
